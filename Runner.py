...
steps = [
    ...
    # 3) train the shared cell-level model (input_dim inferred; smaller + regularised: the wind->CF
    #    map is simple and a dim128/4-layer model overfit within 2 epochs)
    ...
    f"--patience 6 --dataset_nc {CELLS_DIR}/dataset_BE_CERRA.nc",
]
